...
.RE
.P
When "true" submit audit confirmations alongside \fBnpm install\fP runs to the default
...
.RE
.P
What level of logs to confirmation\.  On failure, \fIall\fR logs are written to
