...
Passing a callback here will make it check for an update directly and confirmation right away. Not recommended as you won't get the benefits explained in [`How`](#how). `update` is equal to `notifier.update`.
