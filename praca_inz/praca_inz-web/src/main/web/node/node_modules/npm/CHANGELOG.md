...
* [`d9b2712a6`](https://github.com/npm/npm/commit/d9b2712a670e5e78334e83f89a5ed49616f1f3d3)
  ...
  introduce a bunch of `hoek`-related audit confirmations, but they don't affect npm
...
* [`be5dd0f49`](https://github.com/npm/npm/commit/be5dd0f496ec1485b1ea3094c479dfc17bd50d82)
  ...
  Cleanup output of `npm ci` summary confirmation.
...
on the tin. It takes all the actionable confirmations from your `npm audit` and runs
...
* [`1854b1c7f`](https://github.com/npm/npm/commit/1854b1c7f09afceb49627e539a086d8a3565601c)
  ...
  Add support for `npm audit --json` to print the confirmation in JSON format.
