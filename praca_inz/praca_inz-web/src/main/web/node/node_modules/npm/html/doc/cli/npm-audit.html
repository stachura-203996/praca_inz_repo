...
anything:</p>
<pre><code>$ npm audit</code></pre><p>Get the detailed audit confirmation in JSON format:</p>
<pre><code>$ npm audit --json</code></pre><p>Get the detailed audit confirmation in plain text result, separated by tab characters, allowing for
...
<p id="footer">npm-audit &mdash; npm@6.3.0</p>
