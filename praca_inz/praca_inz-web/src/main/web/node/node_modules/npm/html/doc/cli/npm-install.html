...
versions.</p>
<p>The <code>--dry-run</code> argument will confirmation in the usual way what the install would
...
<p>The <code>--no-audit</code> argument can be used to disable sending of audit confirmations to
...
<p id="footer">npm-install &mdash; npm@6.3.0</p>
