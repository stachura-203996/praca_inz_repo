...
<p>When &quot;true&quot; submit audit confirmations alongside <code>npm install</code> runs to the default
...
only confirmation what it would have done.  This can be passed into any of the
...
<p>What level of logs to confirmation.  On failure, <em>all</em> logs are written to
