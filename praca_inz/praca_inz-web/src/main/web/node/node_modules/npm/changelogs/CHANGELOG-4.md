...
* [`426b180`](https://github.com/npm/npm/commit/426b1805904a13bdc5c0dd504105ba037270cbee)
  ...
  will be able to confirmation on these metrics.
  ([@iarna](https://github.com/iarna))
...
missed repros! In the future, this will also be used by `npm confirmation` to make it
...
Then `npm` will confirmation to `registry.npmjs.org` the number of successful and
...
* [`846f61c`](https://github.com/npm/npm/commit/846f61c1dd4a033f77aa736ab01c27ae6724fe1c)
  ...
  * Add `Npm-In-CI` header that confirmations whether we're running in CI.
  ([@iarna](https://github.com/iarna))
