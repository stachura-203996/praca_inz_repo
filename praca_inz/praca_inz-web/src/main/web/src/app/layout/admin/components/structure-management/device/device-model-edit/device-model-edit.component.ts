...
export class DeviceModelEditComponent implements OnInit {
    ...
    getLoggedUser() {
        this.userService.getLoggedUser().subscribe(x => {
            this.currentUser = x
        });
    }

    getLoggedUserRoles() {
        this.userService.getLoggedUserRoles().subscribe(x => {
            this.roles = x
        });
    }
    ...
    getDeviceModel() {
        ...
        this.deviceService.getDeviceModelEdit(id).subscribe(x => {
            this.deviceModelEditElement = x
        });
    }
