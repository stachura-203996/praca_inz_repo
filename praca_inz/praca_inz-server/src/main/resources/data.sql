...
INSERT INTO device_model(ID,VERSION,DELETED,NAME) VALUES (1,0,FALSE ,'COMPUTER');

INSERT INTO DEVICE(ID, VERSION,DELETED,NAME,SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_MODEL_ID,MANUFACTURE,LAST_UPDATE,COMPANY_ID) VALUES (1,0,FALSE ,'Komputer', 'XYZ10ABC', 1,1,'pol','2018-03-12 12:00',1);
INSERT INTO DEVICE(ID,VERSION,DELETED,NAME, SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_MODEL_ID,MANUFACTURE,LAST_UPDATE,COMPANY_ID) VALUES (2,0,FALSE ,'Monitor', 'XYZ11ABC', 1,1,'pol','2011-03-12 12:00',1);
 INSERT INTO DEVICE(ID,VERSION,DELETED,NAME, SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_MODEL_ID,MANUFACTURE,LAST_UPDATE,COMPANY_ID) VALUES (3,0,FALSE ,'Klawiatura-bezprzewodowa', 'XYZ12ABC', 1,1,'pol','2011-03-12 12:30',1);
INSERT INTO DEVICE(ID,VERSION,DELETED,NAME, SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_MODEL_ID,MANUFACTURE,LAST_UPDATE,COMPANY_ID) VALUES (4,0,FALSE ,'Myszka-laserowa' ,'XYZ13ABC', 1,1,'pol','2011-03-12 12:00',1);
