...
INSERT INTO ADDRESS(ID, VERSION,CITY, BUILDING_NUMBER, STREET, ZIP_CODE) VALUES (1,0, 'Kraków', 1, 'Street X', '12-341');
INSERT INTO ADDRESS(ID, VERSION, CITY,  BUILDING_NUMBER, STREET, ZIP_CODE) VALUES (2,0, 'Warszawa', 2, 'Street Y', '12-342');
INSERT INTO ADDRESS(ID, VERSION, CITY,  BUILDING_NUMBER, STREET, ZIP_CODE,FLAT_NUMBER) VALUES (3,0, 'Łódź',  3, 'Street Z', '12-343',2);
INSERT INTO ADDRESS(ID, VERSION, CITY,  BUILDING_NUMBER, STREET, ZIP_CODE) VALUES (4,0, 'Lódz',  4, 'Street XX', '12-344');
INSERT INTO ADDRESS(ID, VERSION, CITY,  BUILDING_NUMBER, STREET, ZIP_CODE) VALUES (5,0, 'Rzeszów',  5, 'Street YY', '12-345');
INSERT INTO ADDRESS(ID, VERSION, CITY,  BUILDING_NUMBER, STREET, ZIP_CODE) VALUES (6,0, 'Lublin',  6, 'Street ZZ', '12-346');
INSERT INTO ADDRESS(ID, VERSION, CITY,  BUILDING_NUMBER, STREET, ZIP_CODE) VALUES (7,0, 'Sopot',  7, 'Street XXX', '12-347');

INSERT INTO COMPANY(ID, VERSION, NAME, MAIN_OFFICE_ADRESS_ID,DESCRIPTION) VALUES (1,0, 'Transition Technologies',1, 'OPISsdsdsdsdsdsdsdsd  sdsdsdddd dddddddddddddddd dddddddddd ddddddddddd dddddddddddd dddddddddddddddd dddddddddddddddddddd dddddddddddddddddddddd ddddddddddd');


INSERT INTO DEPARTMENT(ID, VERSION, NAME, COMPANY_ID,DESCRIPTION) VALUES (1,0, 'Sales & Marketing', 1,'OPISsdsdsdsdsdsdsdsd  sdsdsdddd dddddddddddddddd dddddddddd ddddddddddd dddddddddddd dddddddddddddddd dddddddddddddddddddd dddddddddddddddddddddd ddddddddddd');
INSERT INTO DEPARTMENT(ID, VERSION, NAME, COMPANY_ID) VALUES (2,0, 'Research & Development', 1);
INSERT INTO DEPARTMENT(ID, VERSION, NAME, COMPANY_ID) VALUES (3,0, 'Administration', 1);
INSERT INTO DEPARTMENT(ID, VERSION, NAME, COMPANY_ID) VALUES (4,0, 'Human Resources', 1);
INSERT INTO DEPARTMENT(ID, VERSION, NAME, COMPANY_ID) VALUES (5,0, 'Sales & Marketing', 1);


 INSERT INTO OFFICE(ID, VERSION, NAME, ADDRESS_ID, DEPARTMENT_ID,DESCRIPTION) VALUES (1,0, 'Office of S&M Boston', 4, 1,'OPIS');
 INSERT INTO OFFICE(ID, VERSION, NAME, ADDRESS_ID, DEPARTMENT_ID) VALUES (2,0, 'Office of S&M New York', 5, 1);
 INSERT INTO OFFICE(ID, VERSION, NAME, ADDRESS_ID, DEPARTMENT_ID) VALUES (3,0, 'Office of R&D Boston', 6, 2);
 INSERT INTO OFFICE(ID, VERSION, NAME, ADDRESS_ID, DEPARTMENT_ID) VALUES (4,0, 'Office of A Los Angeles', 7, 3);
...
INSERT  INTO WAREHOUSE (ID, VERSION,USER_ID,NAME) VALUES (1,0,1,'admin');
INSERT INTO  WAREHOUSE(ID, VERSION,USER_ID,NAME,OFFICE_ID) VALUES (2,0,1,'OFFICE_WAREHOUSE',1);

INSERT INTO device_type(ID,VERSION,NAME) VALUES (1,0,'COMPUTER');

INSERT INTO DEVICE(ID, VERSION,NAME,SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_TYPE_ID) VALUES (1,0,'Komputer', 'XYZ10ABC', 1,1);
INSERT INTO DEVICE(ID,VERSION,NAME, SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_TYPE_ID) VALUES (2,0,'Monitor', 'XYZ11ABC', 1,1);
 INSERT INTO DEVICE(ID,VERSION,NAME, SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_TYPE_ID) VALUES (3,0,'Klawiatura-bezprzewodowa', 'XYZ12ABC', 1,1);
INSERT INTO DEVICE(ID,VERSION,NAME, SERIAL_NUMBER, WAREHOUSE_ID,DEVICE_TYPE_ID) VALUES (4,0,'Myszka-laserowa' ,'XYZ13ABC', 1,1);

INSERT INTO TRANSFER (ID,VERSION,TITLE,TRANSFER_DATE,SENDER_WAREHOUSE_ID,RECIEVER_WAREHOUSE_ID,DEVICE_ID) VALUES (1,0,'TITLE','2011-03-12',1,2,1);

INSERT INTO notification(ID,VERSION,TITLE,DESCRIPTION,URL,READED,NOTIFICATION_DATE,USER_ID) VALUES (1,0,'Title','Description','/devices/transfer/view/1',FALSE ,'2011-03-12',1);
INSERT INTO notification(ID,VERSION,TITLE,DESCRIPTION,URL,READED,NOTIFICATION_DATE,USER_ID) VALUES (2,0,'Title','Description','/devices/transfer/view/2',FALSE ,'2011-03-12',1);