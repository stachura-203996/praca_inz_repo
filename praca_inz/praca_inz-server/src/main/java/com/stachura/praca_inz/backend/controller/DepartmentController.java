...
public class DepartmentController {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<?> create(@RequestBody Department company) {
        departmentService.create(company);
        HttpHeaders headers = new HttpHeaders();
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(DepartmentController.class).get(company.getId()));
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public void update(@RequestBody Department company) {
