...
public class SystemMessageRepositoryImpl extends AbstractRepository<SystemMessage> implements SystemMessageRepository {
    ...
    @Override
    public void edit(SystemMessage entity) throws EntityException {
        try {
            super.edit(entity);
            ...
            throw EntityOptimisticLockException.createOptimisticLock(EntityOptimisticLockException.SYSTEM_MESSAGE_OPTIMISTIC_LOCK, ole);
