...
public interface ConfirmationService {
    ...
    List<ConfirmationListElementDto> getAllReports(String username) throws AppBaseException;

    Confirmation createNewReport(ConfirmationAddDto confirmationAddDto, String username) throws AppBaseException;

    void updateReport(Confirmation confirmation) throws AppBaseException;
